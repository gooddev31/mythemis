...
const AuthFormComponent = (props: { type: "login" | "register" | "recovery" }) => {
    return (
            ...
            <div className="container">
                ...
                <div className="ml-[28.24px] mt-[66px] w-[521px]">
                    <div className="flex justify-between items-center">
                        ...
                        {props.type === "register" || props.type === "recovery" ? (
                            <Link href="/authorization/login" className="font-[700] text-[18px]">
                                <span className="text-[#99B2C6]">Üye misin?</span> Giriş yap.
                            </Link>
                        ) : null}
                    </div>
