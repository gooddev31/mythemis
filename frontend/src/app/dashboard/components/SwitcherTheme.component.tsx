    ...
    if(theme === "light") {
        return(
            <div className="flex gap-[9px] ">
                ...
                <button onClick={() => setTheme("dark")} className="w-[37px] h-[22.49] rounded-full bg-[#99B2C6] px-[1.45px] py-[1.75px]">
        ...
        return(
            <div className="flex gap-[9px] ">
                ...
                <button onClick={() => setTheme("light")} className="w-[37px] h-[22.49] rounded-full bg-[#99B2C6] px-[1.45px] py-[1.75px]">
                    <div className="w-[20px] h-[20px] rounded-full bg-[#FFFFFF] ml-[13px] transition">
                    </div>
                </button>
